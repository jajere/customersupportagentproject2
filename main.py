...
async def invoke(payload, context=None):
    ...
    try:
        ...
        #
        # Gateway-specific errors are handled explicitly so that:
        #   - failures are logged with useful diagnostic information
        #   - users receive a safe, meaningful response
        #   - technical Gateway errors are not exposed to the user
        try:
